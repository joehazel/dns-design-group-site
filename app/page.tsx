          ...
          <div className="grid gap-8 rounded-[2rem] bg-[#2f2925] p-8 text-white shadow-2xl lg:grid-cols-[1fr_1fr] lg:p-12">
            <div>
              ...
              <p className="mt-6 max-w-xl leading-8 text-[#ece2d9]">
                ...
                start the conversation. This section can easily be updated later
                with a live inquiry form, phone number, email, or studio address.
              </p>
            </div>
            ...
            <div className="rounded-[1.75rem] bg-[#f7efe6] p-6 text-[#2f2925]">
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    className="w-full rounded-xl border border-[#d8c8b8] bg-white px-4 py-3 outline-none"
                ...
                <div>
                  ...
                  <textarea
                    className="min-h-[140px] w-full rounded-xl border border-[#d8c8b8] bg-white px-4 py-3 outline-none"
                    placeholder="Tell us about your space, style, and goals"
                  />
                </div>
                <button className="w-full rounded-full bg-[#2f2925] px-6 py-3 text-sm font-medium text-white transition hover:opacity-90">
                  Send Inquiry
                </button>
              </div>
            </div>
